...
fn main() {
    ...
    let text1 = Text::plain("Padded on all sides").style(Style::new().bold().foreground(Color::Green));
    ...
    let text2 = Text::plain("Vertical: 1, Horizontal: 4").style(Style::new().foreground(Color::Cyan));
    ...
    let text3 = Text::plain("Custom padding per side").style(Style::new().foreground(Color::Magenta));
    ...
    let panel_content = Text::plain("Panel with padding").style(Style::new().foreground(Color::Yellow));
