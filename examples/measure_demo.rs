...
use rich_rust::measure::{Measurement, Measurable};
...
fn main() {
    ...
    console.print(&format!("  Short text: {} lines, {} chars wide",
        m_short.lines, m_short.maximum));
    console.print(&format!("  Long text:  {} lines, {} chars wide",
    ...
    for width in [30, 40, 50, 60] {
        ...
        console.print(&format!("  At width {}: {} lines ({})",
            width, m.lines, if m.fits(width, 5) { "FITS" } else { "TOO TALL" }));
    }
