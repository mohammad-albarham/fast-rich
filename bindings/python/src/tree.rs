use pyo3::prelude::*;
use rich_rust::tree::{Tree, GuideStyle};
...
impl PyTree {
    ...
    fn new(label: &str, style: Option<PyStyle>, guide_style: Option<String>, expanded: bool, highlight: bool) -> Self {
    ...
    fn add(&mut self, label: &str) -> PyTree {
        ...
        PyTree { inner: Tree::new("dummy".to_string()) }
    }
